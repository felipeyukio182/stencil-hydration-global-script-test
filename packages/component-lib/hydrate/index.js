...
/*!
 Stencil Mock Doc v4.16.0 | MIT Licensed | https://stenciljs.com
 */
...
const createTime = (e, t = "") => {
 ...
 for (n of sortedAttrNames(Object.keys(l))) n in a || setAccessor(s, n, l[n], void 0);
 for (n of sortedAttrNames(Object.keys(a))) setAccessor(s, n, l[n], a[n]);
};
...
class MyComponent {
    ...
    render() {
        return hAsync("div", { key: 'eabef0c1a1ca8e2107fa997c569497b384f71c35', style: { "color": "var(--stencil-custom-color, " + this.red + ")" } }, "Hello, World! I'm ", this.getText());
    }
